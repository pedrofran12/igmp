...
from .igmp2.igmp_globals import VERSION_1_MEMBERSHIP_REPORT, VERSION_2_MEMBERSHIP_REPORT, LEAVE_GROUP,\
    MEMBERSHIP_QUERY
...
class InterfaceIGMP(Interface):
    ...
    def __init__(self, interface_name: str, vif_index: int = 0):
        ...
        from igmp.igmp2.RouterState import RouterState
    ...
    def _receive(self, raw_bytes, src_addr):
        ...
        if raw_bytes:
            ...
            if not (ip_src == "0.0.0.0" or IPv4Address(ip_src).is_multicast):
                self.PKT_FUNCTIONS.get(InterfaceIGMP.receive_unknown_type)(self, packet)
